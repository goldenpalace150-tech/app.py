...
try:
    ...
    # تحسين: قراءة الأعداد الصحيحة لجميع الأيام (سواء اليوم الحاضر أو التاريخ المختار)
    ...
    # عرض الجداول تفاعلياً لجميع الأيام (اليوم وتاريخ الأرشيف)
    if current_view == "all":
    ...
    st.error(TEXT_CONFIG["err_api"].format(str(e)))import streamlit as st
import requests
import unicodedata
import pandas as pd
import io
